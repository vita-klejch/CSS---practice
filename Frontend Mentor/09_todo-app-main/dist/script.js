...
// GLOBAL VARIABLES
let topId = 0; // keep track about TOP TODO ID - for creating new TODOs
let toDoData = []; // stores all displayed TODO
// GLOBAL CONSTANTS
...
function handleFilterDisplay(newFilterName) {
    filterBtn.forEach((btn) => {
        const filterType = btn.dataset.filter;
...
function loadData() {
    ...
    const loadedData = JSONdata && JSON.parse(JSONdata);
    toDoData = loadedData;
    if (toDoData) {
...
function displayData(dataToDisplay) {
    ...
    if (dataToDisplay) {
        dataToDisplay.forEach((itemData) => {
            ...
            todoList === null || todoList === void 0 ? void 0 : todoList.appendChild(itemComponent);
        });
    }
    const filterArea = ((_a = document.querySelector(".js-filter-area")) === null || _a === void 0 ? void 0 : _a.children[0]);
    // adds second filter area
    // - it is displayed on different screen size (tablets and bigger)
    const filterClone = filterArea === null || filterArea === void 0 ? void 0 : filterArea.cloneNode(true);
    ...
    todoList === null || todoList === void 0 ? void 0 : todoList.appendChild(infoArea);
}
// INIT - calls loading func. and displays returned data
function populateItems() {
    const data = loadData();
    displayData(data);
    counterItem = document.querySelector(".js-todo-counter");
    refreshCounter();
}
...
function getItemComponent(itemData, isNewComponent = false) {
    ...
    checkboxElement.addEventListener("click", () => toggleCompleteStatus(itemElement));
...
function toggleCompleteStatus(itemToToggle) {
...
function addNewTodo(todoTitle) {
    ...
    todoList === null || todoList === void 0 ? void 0 : todoList.insertBefore(newTodoItem, todoList.lastChild);
